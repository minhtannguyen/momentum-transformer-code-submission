...
from ..transformers import TransformerEncoder, TransformerEncoderLayer, \
    TransformerMomentumEncoder, TransformerMomentumEncoderLayer, \
    TransformerAdaptiveEncoder, TransformerAdaptiveEncoderLayer, \
    TransformerDecoder, TransformerDecoderLayer
from ..recurrent.attention import \
    RecurrentAttentionLayer, \
    RecurrentCrossAttentionLayer
from ..recurrent.transformers import \
    RecurrentTransformerEncoder, RecurrentTransformerEncoderLayer, RecurrentTransformerAdaptiveEncoder, RecurrentTransformerAdaptiveEncoderLayer, \
...
class TransformerAdaptiveEncoderBuilder(BaseTransformerEncoderBuilder):
    ...
    """
    def __init__(self):
        super(TransformerAdaptiveEncoderBuilder, self).__init__()
        self._res_stepsize = 1.0
        self._res_delta = 0.0001
        self._adaptive_type = "wang"
        self._is_resw = False
    ...
    def _get_encoder_class(self):
        """Return the class for the transformer encoder."""
        return TransformerAdaptiveEncoder

    def _get_encoder_layer_class(self):
        """Return the class for the transformer encoder layer."""
        return TransformerAdaptiveEncoderLayer
    
    @property
    def res_stepsize(self):
        """The step size for the momentum residual connection."""
        return self._res_stepsize

    @res_stepsize.setter
    def res_stepsize(self, val):
        self._res_stepsize = val
        
    @property
    def res_delta(self):
        """The delta for the momentum residual connection."""
        return self._res_delta

    @res_delta.setter
    def res_delta(self, val):
        self._res_delta = val
    
    @property
    def adaptive_type(self):
        """The adaptive_type for the momentum residual connection."""
        return self._adaptive_type

    @adaptive_type.setter
    def adaptive_type(self, val):
        self._adaptive_type = val
        
    @property
    def is_resw(self):
        """To use additional weight on the momentum update for the momentum residual connection or not."""
        return self._is_resw

    @is_resw.setter
    def is_resw(self, val):
        self._is_resw = val
        ...
        return Encoder(
            [
                EncoderLayer(
                    ...
                    self.activation,
                    event_dispatcher=self.event_dispatcher,
                    res_stepsize=self.res_stepsize,
                    res_delta=self.res_delta,
                    adaptive_type=self.adaptive_type,
                    is_resw=self.is_resw
                )
                for _ in range(self.n_layers)
            ],
            (LayerNorm(model_dimensions) if self.final_normalization else None),
...
class TransformerMomentumEncoderBuilder(BaseTransformerEncoderBuilder):
    """Build a batch transformer encoder for training or processing of
    sequences all elements at a time.
    ...
    """
    def __init__(self):
        super(TransformerMomentumEncoderBuilder, self).__init__()
        self._res_stepsize = 1.0
        self._res_mu = 0.0
        self._is_resw = False
    ...
    def _get_encoder_class(self):
        """Return the class for the transformer encoder."""
        return TransformerMomentumEncoder

    def _get_encoder_layer_class(self):
        """Return the class for the transformer encoder layer."""
        return TransformerMomentumEncoderLayer
    ...
    @property
    def res_mu(self):
        """The momentum value for the momentum residual connection."""
        return self._res_mu
...
class RecurrentAdaptiveEncoderBuilder(BaseTransformerEncoderBuilder):
    ...
    """
    def __init__(self):
        super(RecurrentAdaptiveEncoderBuilder, self).__init__()
        self._res_stepsize = 1.0
        self._res_delta = 0.0001
        self._adaptive_type = "wang"
        self._is_resw = False
    ...
    def _get_encoder_class(self):
        ...
        return RecurrentTransformerAdaptiveEncoder

    def _get_encoder_layer_class(self):
        """Return the class for the recurrent transformer encoder layer."""
        return RecurrentTransformerAdaptiveEncoderLayer
