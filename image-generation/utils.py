...
def add_transformer_arguments(parser):
    parser.add_argument(
        "--attention_type",
        type=str,
        choices=["full", "causal-linear", "reformer","causal-momentum","causal-ncmomentum","causal-ncmomentum-py"],
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0001,
        help="Delta scalar to be used for scaling the gradients in adaptive momentum transformer layers"
    )
    parser.add_argument(
        "--res_stepsize",
        type=float,
