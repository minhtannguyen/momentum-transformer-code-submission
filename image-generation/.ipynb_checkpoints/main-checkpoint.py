...
def evaluator(evaluate_freq, model, dataloader, device, writer=None, logger=None):
    global best_loss
    global best_bpd
    def inner(iteration):
        global best_loss
...
def main(argv=None):
    ...
    callbacks = callback_chain(
        ...
        evaluator(args.evaluate_frequency, model, test_loader, device, writer=writer, logger=logger),
