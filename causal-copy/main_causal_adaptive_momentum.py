...
class SequencePredictor(torch.nn.Module):
    def __init__(self, d_model, sequence_length, n_classes,
                 ...
                 bits=32, rounds=4,
                 chunk_size=32, masked=True, mu=0.0, stepsize=1.0, delta=0.0001, res_stepsize=1.0, res_delta=0.0001, adaptive_type="nc", is_resw=False):
        ...
        self.transformer = TransformerAdaptiveEncoderBuilder.from_dictionary(
            self.builder_dict,
            strict=True
        ).get()
