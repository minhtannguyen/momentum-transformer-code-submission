...
python main_adam.py --save_to "/tanData/momentum_transformer/rnn_adam_biascorrection_v2_causal_mu_0.9_step_0.1_beta_0.3" --attention_type adam-linear --mu 0.9 --stepsize 0.1 --beta 0.3 --manualSeed 0 --gpu-id 0 &


# GPU 3

python main_adam.py --save_to "/tanData/momentum_transformer/rnn_adam_biascorrection_v2_causal_mu_0.9_step_1.0_beta_0.3" --attention_type adam-linear --mu 0.9 --stepsize 1.0 --beta 0.3 --manualSeed 0 --gpu-id 1 &

# GPU 4

python main_adam.py --save_to "/tanData/momentum_transformer/rnn_adam_biascorrection_v2_causal_mu_0.9_step_0.01_beta_0.3" --attention_type adam-linear --mu 0.9 --stepsize 0.01 --beta 0.3 --manualSeed 0 --gpu-id 2 &


python main_adam.py --save_to "/tanData/momentum_transformer/rnn_adam_biascorrection_v2_causal_mu_0.9_step_0.001_beta_0.3" --attention_type adam-linear --mu 0.9 --stepsize 0.001 --beta 0.3 --manualSeed 0 --gpu-id 3 &

# GPU 5

python main_adam.py --save_to "/tanData/momentum_transformer/rnn_adam_biascorrection_v2_causal_mu_0.9_step_0.0001_beta_0.3" --attention_type adam-linear --mu 0.9 --stepsize 0.0001 --beta 0.3 --manualSeed 0 --gpu-id 6 &


python main_adam.py --save_to "/tanData/momentum_transformer/rnn_adam_biascorrection_v2_causal_mu_0.9_step_0.00001_beta_0.3" --attention_type adam-linear --mu 0.9 --stepsize 0.00001 --beta 0.3 --manualSeed 0 --gpu-id 7 &
