...
CUDA_VISIBLE_DEVICES=4 python3 run_tasks.py --model "softmax" --task pathfinder32-curv_contour_length_14 --use_wandb --project_name 'lra' --job_name pathfinder32-curv_baseline-softmax-seed-0-final --seed 0 &

CUDA_VISIBLE_DEVICES=4 python3 run_tasks.py --model "linear" --task pathfinder32-curv_contour_length_14 --use_wandb --project_name 'lra' --job_name pathfinder32-curv_baseline-linear-seed-0-final --seed 0 &
