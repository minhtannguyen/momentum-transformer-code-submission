...
import math
from model import Model, ModelAdaptive, ModelMomentum
...
class ModelForSCAdaptive(nn.Module):
    def __init__(self, config):
        super().__init__()
        ...
        self.model = ModelAdaptive(config)
...
class ModelForSCMomentum(nn.Module):
    def __init__(self, config):
        super().__init__()
        ...
        self.model = ModelMomentum(config)
...
class ModelForSCDualAdaptive(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class ModelForSCDualMomentum(nn.Module):
    def __init__(self, config):
        super().__init__()
