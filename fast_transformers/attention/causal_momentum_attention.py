...
class CausalMomentumAttention(Module):
    ...
    def __init__(self, query_dimensions, mu, stepsize, feature_map=None, eps=1e-6,
                 event_dispatcher=""):
        super(CausalMomentumAttention, self).__init__()
        self.feature_map = (
    ...
    def forward(self, queries, keys, values, attn_mask, query_lengths,
        ...
        if not attn_mask.lower_triangular:
            raise RuntimeError(("CausalMomentumAttention only supports full "
...
AttentionRegistry.register(
    "causal-momentum", CausalMomentumAttention,
    [
