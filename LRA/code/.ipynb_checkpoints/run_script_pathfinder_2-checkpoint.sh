...
CUDA_VISIBLE_DEVICES=5 python3 run_tasks.py --model "sparselowrank" --task pathfinder32-curv_contour_length_14 --diag_size 20 --sparse_ratio 2.5 --kernels 'elu' --use_wandb --project_name 'lra' --job_name pathfinder32-sparselowrank-diag-size-20-elu-wscalar-convex-seed-0-final --seed 0 &

CUDA_VISIBLE_DEVICES=5 python3 run_tasks.py --model "sparselowrank" --task pathfinder32-curv_contour_length_14 --diag_size 40 --sparse_ratio 2.5 --kernels 'elu' --use_wandb --project_name 'lra' --job_name pathfinder32-sparselowrank-diag-size-40-elu-wscalar-convex-seed-0-final --seed 0 &

CUDA_VISIBLE_DEVICES=6 python3 run_tasks.py --model "sparselowrank" --task pathfinder32-curv_contour_length_14 --diag_size 20 --sparse_ratio 6.5 --kernels 'elu' --use_wandb --project_name 'lra' --job_name pathfinder32-sparselowrank-diag-size-20-seed-0-final --seed 0 &

CUDA_VISIBLE_DEVICES=7 python3 run_tasks.py --model "sparselowrank" --task pathfinder32-curv_contour_length_14 --diag_size 40 --sparse_ratio 6.5 --kernels 'elu' --use_wandb --project_name 'lra' --job_name pathfinder32-sparselowrank-diag-size-40-seed-0-final --seed 0 &
